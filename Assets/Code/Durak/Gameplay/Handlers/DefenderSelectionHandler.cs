...
namespace Framework.Durak.Gameplay.Handlers
{
    ...
    {
        public DefenderSelectionHandler(IBoard<Data> board, IMap<ICard, Data> map, IPlayerQueue<IPlayer> queue, IDefenderValidator validator, IBoardCardMovement movement)
